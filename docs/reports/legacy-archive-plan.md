...
|------|------------|---------------------|-------------|------|--------|
| `router/legacy/__init__.py` | yes | 2026-06-22 | LEGACY_OPTIMIZER | high | keep |
| `router/legacy/agent_runs.py` | yes | 2026-06-21 | AGENT_RUNS_DIR, AGENT_RUNS_ENABLED, AGENT_RUNS_MAX_EVENTS | high | keep |
| `router/legacy/context_optimizer.py` | no | 2026-06-22 | - | medium | deprecate_env |
...
| `router/legacy/runtime_optimizer.py` | no | 2026-06-22 | - | medium | deprecate_env |
